            ...
            <ul class="flex border-b">
                <li class="mr-1">
                    <a class="bg-white inline-block py-2 px-4 text-blue-500 hover:text-blue-800 font-semibold"
                        href="{{ url('/jenismangrove') }}">Jenis</a>
                </li>
                <li class="-mb-px mr-1">
                            ...
                            <tbody id="myTable">
                                @foreach ($data as $item)
                                    <tr
                                        ...
                                        <th scope="row"
                                            class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                            {{ $item->namajenisindo }} ( {{ $item->namajenislatin }} )
                                        </th>

                                        <td class="px-6 py-4">
                                            <form action="{{ route('mangrove.destroy', $item->idmangrove) }}"
                                                method="post" id="form_delete">

                                                <div class="justify-center">
                                                    <a href="{{ route('mangrove.edit', $item->idmangrove) }}"
