                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    <div class="float-right mb-2">
                        <form action="{{ action('KecamatanController@create') }}">
                            <button type="submit" class="bg-transparent hover:bg-blue-500 text-blue-700 font-semibold hover:text-white py-2 px-4 border border-blue-500 hover:border-transparent rounded">Tambah
                            </button>
                        </form>
                    </div>
                                ...
                                <td class="border text-center">
                                    <form action="{{ route('kecamatan.destroy', $item->idkec) }}" method="post">
                                        <div class="justify-center">
                                            <a href="{{ route('kecamatan.edit', $item->idkec) }}" class="inline-flex pr-5">
